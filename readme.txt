...
= 1.3.6.4, October 23rd, 2024 =

**Fixes**

* Fixed Gutemberg compatibility up to v19.4.0
...
* Fixed the default font sizes not showing up in newsletters.
...
* **Bug fix:** Sending a newsletter on Firefox is not working. This is now fixed.
